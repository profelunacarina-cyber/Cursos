...
<template>
  <section class="evaluation-builder">
    <div class="builder-head"><div><h3>Preguntas de la evaluación</h3><p>Armá preguntas de opción múltiple o verdadero/falso. Marcá una respuesta correcta por pregunta.</p></div><button type="button" class="button button-icon" @click="nuevaPregunta"><PlusCircle :size="19" /> Agregar pregunta</button></div>
